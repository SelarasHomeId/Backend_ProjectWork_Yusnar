...
func (h *handler) Create(c echo.Context) (err error) {
	payload := new(dto.BoardCreateRequest)
...
func (h handler) Delete(c echo.Context) (err error) {
	payload := new(dto.BoardDeleteByIDRequest)
	if err := c.Bind(payload); err != nil {
		return response.ErrorBuilder(http.StatusBadRequest, err, "error bind payload").SendError(c)
	}
	if err = c.Validate(payload); err != nil {
...
func (h handler) Update(c echo.Context) (err error) {
	payload := new(dto.BoardUpdateRequest)
	if err = c.Bind(payload); err != nil {
		return response.ErrorBuilder(http.StatusBadRequest, err, "error bind payload").SendError(c)
	}
	if err = c.Validate(payload); err != nil {
...
func (h handler) FindByWorkspaceId(c echo.Context) (err error) {
	payload := new(dto.BoardFindByWorkspaceIDRequest)
	if err := c.Bind(payload); err != nil {
		return response.ErrorBuilder(http.StatusBadRequest, err, "error bind payload").SendError(c)
	}
	if err = c.Validate(payload); err != nil {
	...
	data, err := h.service.FindByWorkspaceId(c.(*abstraction.Context), payload)
	if err != nil {
		return response.ErrorResponse(err).SendError(c)
	}
	return response.SuccessResponse(data).SendSuccess(c)
