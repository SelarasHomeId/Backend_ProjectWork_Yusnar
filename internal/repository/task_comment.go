...
// func (r *task_comment) CountByBoardIdArr(ctx *abstraction.Context, board_id int) (data *int, err error) {
// 	where, whereParam := general.ProcessWhereParam(ctx, "task_comment", "is_delete = @false"+fmt.Sprintf(" AND board_id = %d", board_id))
